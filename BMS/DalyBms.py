...
class DalyBms(ThreadObject):
    ...
    def __init__(self, threadName : str, configuration : dict, interfaceQueues : dict = None):
        ...
        Constructor
        '''
        self.dalyBmsInterfaceQueue = Queue()
        super().__init__(threadName, configuration, [self.dalyBmsInterfaceQueue])
    ...
    def threadBreak(self):
        time.sleep(10)           # that's fast enough!
